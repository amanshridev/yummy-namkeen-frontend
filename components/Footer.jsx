...
const Footer = () => {
    return (
        ...
        <footer className="bg-[#FE9400] dark:bg-gray-900">
            <div className="mx-auto w-full p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="#" className="flex items-center">
                            <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Yummy Namkeen</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-white dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="#" className="hover:underline">Yummy Namkeen</a>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">Yummy Namkeen</a>. All Rights Reserved.
                    </span>
...
//<Icon icon="ic:round-account-circle" color="#fe9400" /> <Icon icon="material-symbols:shopping-bag-outline" color="#fe9400" /> <Icon icon="mingcute:shopping-bag-1-line" color="#fe9400" />